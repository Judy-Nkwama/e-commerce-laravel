<form action="/products" class="row justify-content-center py-3 px-md-5 text-bg-danger">
    <div class="col col-md-8 bg-white d-flex rounded rounded-4 overflow-hidden px-0 mb-2">
